# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2018-12-17 08:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_type', models.CharField(choices=[('fulltime', '脱产班'), ('online', '网络班'), ('weekend', '周末班')], default='uflltime', max_length=64, verbose_name='班级类型')),
                ...
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='资讯日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.ClassList', verbose_name='所报班级')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(blank=True, choices=[('Linux', 'Linux中高级'), ('PythonFullStack', 'Python高级全栈开发')], max_length=64, null=True, verbose_name='课程名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, default=True, null=True, verbose_name='备注')),
